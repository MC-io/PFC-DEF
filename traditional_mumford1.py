...
def main():
    ...
    g_user_cost = []
    g_coverage = []
    for nroutes in range(13,17):
        ga = GeneticAlgorithm(num_of_individuals=50, generations=20, tndp=tndp, num_of_routes=nroutes, num_of_tour_particips=2, tournament_prob=0.9, min_route=10, max_route=30)
        """
    ...
    plt.savefig('traditional_mumford1.png')
    plt.show()
