...
def main():
    ...
    for nroutes in range(60,61):
        nsga = NSGAII(num_of_individuals=30, generations=30, tndp=tndp, num_of_routes=nroutes, num_of_tour_particips=2, tournament_prob=0.9, min_route=12, max_route=25  )        
        """
