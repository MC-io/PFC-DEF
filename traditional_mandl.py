...
def main():
    ...
    for nroutes in range(5,8):
        ga = GeneticAlgorithm(num_of_individuals=50, generations=20, tndp=tndp, num_of_routes=nroutes, num_of_tour_particips=2, tournament_prob=0.9, min_route=2, max_route=8)
        """
    ...
    plt.savefig('traditional_mandl.png')
    plt.show()
