...
def main():
    ...
    for nroutes in range(56,64):
        ga = GeneticAlgorithm(num_of_individuals=50, generations=20, tndp=tndp, num_of_routes=nroutes, num_of_tour_particips=2, tournament_prob=0.9, min_route=12, max_route=25)
        """
    ...
    plt.savefig('traditional_mumford3.png')
    plt.show()
